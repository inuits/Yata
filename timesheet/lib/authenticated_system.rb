module AuthenticatedSystem
  protected
    ...
    def self.included(base)
      base.send :helper_method, :current_authuser, :logged_in?
    end
    ...
    def login_from_basic_auth
      authenticate_with_http_basic do |username, password|
        self.current_authuser = Authuser.authenticate(username, password)
      end
    end
    ...
    def login_from_cookie
      ...
      if authuser && authuser.remember_token?
        cookies[:auth_token] = { :value => authuser.remember_token, :expires => authuser.remember_token_expires_at }
